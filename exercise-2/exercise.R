...
employees <- paste0("Employee ", seq(1:100))
employees

# Create a vector of 2014 salaries using the runif function
SFor2014 <- runif(100, min = 3000, max = 10000)

# Create a vector of 2015 salaries that are typically higher than the 2014 salaires (use runif again)
SFor2015 <- runif(100, min = 4000, max = 20000)

# Create a data.frame 'salaries' by combining the vectors you just made
salaries <- data.frame(employees, SFor2014, SFor2015)

# Create a column 'raise' that stores the size of the raise between 2014 and 2015
salaries$raise <- SFor2015 - SFor2014

# Create a column 'got.raise' that is TRUE if the person got a raises
salaries$got.raise <- (SFor2015 > SFor2014)

# Retrieve values from your data frame to answer the following questions:
View(salaries)

# What was the 2015 salary of employee 57
salaries[57, "SFor2015"]
